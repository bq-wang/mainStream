...
we will work by create a Printing categories for the set object and we will print out the set members to show you the difference when set members are mofidied
